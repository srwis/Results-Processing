...
=======
 Tree.bias = sub.1 %>% group_by(True.CV, True.omega3.value)
>>>>>>> 96b5f07113a6905d18fbe0fcc37b6751441ec0f4
...
b %>%  filter( stat == "MLE") %>% ggplot(aes(x =True.omega3.value, y = estimate, color = factor(Sites))) + geom_point() + geom_smooth(se =F)+
  facet_grid(True.CV ~ analysis) + geom_hline(yintercept = b$True.omega1.value, color = "red", aes(show.legend = TRUE))
```
...
```{r, echo = FALSE}
b %>%  filter( stat == "MLE") %>% ggplot(aes(x =True.omega3.value, y = estimate, color = factor(Sites))) + geom_point() + geom_smooth(se =F)+
  facet_grid(True.CV ~ analysis) + geom_hline(yintercept = b$True.omega2.value, color = "red", aes(show.legend = TRUE))
```
...
```{r, echo = FALSE}
b %>%  filter( stat == "MLE") %>% ggplot(aes(x =True.omega3.value, y = estimate, color = factor(Sites))) + geom_point() + geom_smooth(se =F) +  facet_grid(True.CV ~ analysis) + geom_abline(slope = 1, intercept = 0, color = 'red')
```
