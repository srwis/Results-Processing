...
```{r pwrvaryalpha}
 ...
 Codons_true_val = read.csv("E:/BRC/SimResults/1000_Codons_true_values.csv", as.is = FALSE) # read in that csv
...
false_pos[15:21,3:4] = 100 -false_pos[15:21,3:4]
...
dev.off()
#-----------------------------------------------------
#that but now witht he alpha.mles
#-----------------------------------------------------
